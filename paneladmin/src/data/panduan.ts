...
export const INITIAL_SCREEN_TIME: ScreenTimeItem[] = [
  ...
  },
  {
    ...
    tips: [
      "Selesaikan PR dan tugas sekolah sebelum hiburan",
...
export const INITIAL_PARENTAL_STEPS: ParentalStep[] = [
  ...
  },
  {
    ...
    step: 5,
    iconName: "bell",
    title: "Monitor dan Review Berkala",
    color: "bg-rose-600",
...
export const INITIAL_FAQ: FaqItem[] = [
  {
    ...
    answer: "Tidak harus dilarang sepenuhnya. Kuncinya adalah penggunaan yang seimbang dan terarah. Gadget bisa menjadi alat belajar yang sangat efektif jika digunakan dengan benar, konten yang tepat, durasi yang sesuai, dan didampingi orang tua.",
  },
  {
    id: "faq-2",
    question: "Bagaimana cara terbaik menegur anak yang kecanduan gadget?",
    answer: "Hindari konfrontasi langsung yang emosional. Mulailah dengan percakapan yang hangat dan empatik. Jelaskan dampaknya dengan bahasa yang sesuai usia. Tawarkan alternatif yang menarik. Buat kesepakatan bersama, bukan aturan sepihak.",
  },
  {
    id: "faq-3",
    question: "Apakah boleh menggunakan gadget untuk keperluan belajar online?",
    answer: "Tentu boleh. Penggunaan untuk keperluan belajar (mengerjakan PR, riset sekolah, kelas online) tidak dihitung dalam batas screen time hiburan. Namun, pastikan aplikasi yang digunakan aman dan orang tua tetap mengetahui kegiatannya.",
  },
  {
    id: "faq-4",
    question: "Sejak usia berapa anak boleh punya smartphone sendiri?",
    answer: "Para ahli umumnya merekomendasikan anak mendapatkan smartphone pertama mereka tidak sebelum usia 12-13 tahun, dan itu pun dengan pengawasan serta aturan yang jelas. Sebelum usia tersebut, gunakan perangkat bersama (shared device) dengan pengawasan ketat.",
  },
  {
    id: "faq-5",
    question: "Bagaimana jika anak marah saat dibatasi penggunaan gadget?",
    answer: "Reaksi marah adalah hal yang normal, terutama di awal penerapan aturan. Tetap tenang dan konsisten. Akui perasaan anak dengan validasi emosi. Tawarkan aktivitas pengganti yang menarik. Libatkan anak dalam membuat aturan agar mereka merasa punya kontrol.",
  },
  {
    id: "faq-6",
    question: "Apakah gadget di kamar tidur anak bahaya?",
    answer: "Ya, sangat tidak disarankan. Gadget di kamar tidur terbukti mengganggu kualitas dan kuantitas tidur anak. Cahaya biru dari layar menekan hormon melatonin. Solusinya: buat 'charging station' di luar kamar dan terapkan aturan gadget dikumpulkan 1 jam sebelum tidur.",
  },
];
